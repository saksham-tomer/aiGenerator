...
export function Tent(props) {
  ...
  return (
    <group ref={groupRef} {...props} dispose={null} rotation={[0, 1, 0]}>
      <RigidBody type="fixed" colliders="hull">
        <group scale={0.01}>
          <mesh
            geometry={nodes.Tent1_Medieval_0.geometry}
            material={materials.Medieval}
            rotation={[-Math.PI / 2, 0, Math.PI / 2]}
            scale={100}
          />
          <mesh
            geometry={nodes.Tent1_Collider_COLLIDER_0.geometry}
